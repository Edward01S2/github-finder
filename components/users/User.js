...
const User = ({ username }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
      <Link href="/">
        <a className="inline-block order border-gray-300 px-3 py-2 shadow-sm font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          Back to Search
        </a>
      </Link>
